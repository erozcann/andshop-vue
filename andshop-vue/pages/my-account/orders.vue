<template>
  ...
  <input v-model="newMessage" placeholder="Mesaj yaz..." />
...
export default {
  ...
  methods: {
    sendMessage() {
      connection.invoke("SendMessage", "Kullanici", this.newMessage);
      this.newMessage = "";
    },
  },
  head() {
      ...
      meta: [
        {
          ...
          name: "description",
          content:
            "Orders page - AndShop Ecommerce Vue js, Nuxt js Template",
        },
      ],
    };
  },
