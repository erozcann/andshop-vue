    ...
    <div class="product_wrappers_one">
      <div class="thumb">
        <nuxt-link :to="{ path: '/product/' + product.id }" class="image">
          <img
  :src="product.images && product.images[0] ? getImageUrl(product.images[0].src) : '/images/default.jpg'"
  :alt="product.title"
/>
<img
  :src="product.images && product.images[1] ? getImageUrl(product.images[1].src) : '/images/default.jpg'"
  :alt="product.title"
  class="hover-image"
/>
...
export default {
  ...
  for (let i = 0; i < Object.keys(variants).length; i++) {
    ...
    if (current && current.color && !uniqColor.includes(current.color)) {
      uniqColor.push(current.color);
    }
  }
  return uniqColor;
},
